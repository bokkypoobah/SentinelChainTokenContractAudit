...
addAccount(eth.accounts[2], "Account #2 - Primary Operator");
addAccount(eth.accounts[3], "Account #3 - Secondary Operator");
...
var primaryOperatorAccount = eth.accounts[2];
var secondaryOperatorAccount = eth.accounts[3];
